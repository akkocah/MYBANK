		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mybank Details",
									"targetURL": "#comsapmybank-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmybank-display": {
								"semanticObject": "comsapmybank",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.mybank",
									"url": sap.ui.require.toUrl("com/sap/mybank")
								}
							}
						}
					}
